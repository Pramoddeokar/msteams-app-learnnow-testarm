...
#pragma warning restore CA1822
        ...
        private void GetKeyVaultByManagedServiceIdentity()
        {
            ...
            this.configuration["SQLStorage:ConnectionString"] = client.GetSecret("SQLStorage_ConnectionString").Value.Value;
            this.configuration["Storage:TableStorageConnectionString"] = client.GetSecret("Storage_TableStorageConnectionString").Value.Value;
            this.configuration["Storage:BlobConnectionString"] = client.GetSecret("Storage_BlobConnectionString").Value.Value;
            this.configuration["CognitiveServiceKey"] = client.GetSecret("CognitiveServiceKey").Value.Value;
            this.configuration["SecurityGroup:GroupId"] = client.GetSecret("SecurityGroup_GroupId").Value.Value;
            this.configuration["SecurityGroup:AdminGroupId"] = client.GetSecret("SecurityGroup_AdminGroupId").Value.Value;
        }
    }
}