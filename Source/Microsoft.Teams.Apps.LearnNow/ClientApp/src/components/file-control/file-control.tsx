            ...
            <>
                <Flex>
                    <div>
                        ...
                        <Button content={this.props.localizer('uploadFileText')} className="attach-file-button" icon={<PaperclipIcon className="attach-icon" outline />} secondary onClick={this.handleClick} value="File" disabled={this.props.isUploadDisable} />
                    </div>
                </Flex>
            </>
        );
